        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Bhirtday = table.Column<DateTime>(type: "timestamp with time zone", nullable: true)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Perscription = table.Column<string>(type: "text", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<long>(type: "bigint", nullable: false),
                    DoctorId = table.Column<long>(type: "bigint", nullable: false),
                    OrdinationId = table.Column<long>(type: "bigint", nullable: false),
                    ...
                    OrdinationId1 = table.Column<long>(type: "bigint", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_Ordinations_OrdinationId",
                        column: x => x.OrdinationId,
                        principalTable: "Ordinations",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Appointments_Ordinations_OrdinationId1",
                        column: x => x.OrdinationId1,
                        principalTable: "Ordinations",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "Bhirtday", "Email", "FirstName", "LastName", "Password", "Phone", "Username" },
                values: new object[,]
                {
                    { 1L, null, "doctor@example.com", "Doctor", "Doctor", "doctor123", "1234567890", "doctor" },
                    { 2L, null, "john.doe@example.com", "John", "Doe", "password123", "0987654321", "john_doe" }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Appointments_OrdinationId",
                table: "Appointments",
                column: "OrdinationId");

            migrationBuilder.CreateIndex(
                name: "IX_Appointments_OrdinationId1",
                table: "Appointments",
                column: "OrdinationId1");
